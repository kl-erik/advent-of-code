...
public class Day9Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(114, day.puzzle1(new File("src/test/resources/year2023/input_09.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(2, day.puzzle2(new File("src/test/resources/year2023/input_09.txt")));
    }
}