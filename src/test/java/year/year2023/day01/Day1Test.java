...
public class Day1Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(142, day.puzzle1(new File("src/test/resources/year/year2023/input_01-1.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(281, day.puzzle2(new File("src/test/resources/year/year2023/input_01-2.txt")));
    }
}