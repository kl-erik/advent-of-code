...
public class Day10Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(8, day.puzzle1(new File("src/test/resources/year2023/input_10-1.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(10, day.puzzle2(new File("src/test/resources/year2023/input_10-2.txt")));
    }
}