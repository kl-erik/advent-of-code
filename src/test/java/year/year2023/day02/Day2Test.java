...
public class Day2Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(8, day.puzzle1(new File("src/test/resources/year2023/input_02.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(2286, day.puzzle2(new File("src/test/resources/year2023/input_02.txt")));
    }
}