...
public class Day4Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(13, day.puzzle1(new File("src/test/resources/year/year2023/input_04.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(30, day.puzzle2(new File("src/test/resources/year/year2023/input_04.txt")));
    }
}