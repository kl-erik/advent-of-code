...
public class Day12Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(21, day.puzzle1(new File("src/test/resources/year2023/input_12.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals((long) 525152, day.puzzle2(new File("src/test/resources/year2023/input_12.txt")));
    }
}