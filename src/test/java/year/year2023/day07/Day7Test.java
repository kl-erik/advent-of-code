...
public class Day7Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(6440, day.puzzle1(new File("src/test/resources/year2023/input_07.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(5905, day.puzzle2(new File("src/test/resources/year2023/input_07.txt")));
    }
}