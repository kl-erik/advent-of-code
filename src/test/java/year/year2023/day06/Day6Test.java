...
public class Day6Test extends TestCase {
    ...
    public void testPuzzle1() throws FileNotFoundException {
        assertEquals(288, day.puzzle1(new File("src/test/resources/year/year2023/input_06.txt")));
    }

    public void testPuzzle2() throws FileNotFoundException {
        assertEquals(71503, day.puzzle2(new File("src/test/resources/year/year2023/input_06.txt")));
    }
}