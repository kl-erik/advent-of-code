...
public class Day19 implements Day {
    ...
    private int getMaxGeodes(int ore, int clay, int obsidian, int geode,
                             int oreRobots, int clayRobots, int obsidianRobots, int geodeRobots, int minutes, ArrayList<String> skip) {
        if (minutes > limit)
            return geode;
    ...
    private void parse(Scanner scanner) {
        String[] split = scanner.nextLine().split("Each (ore|clay|obsidian|geode) robot");
