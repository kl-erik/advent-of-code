...
public class InputCube extends Cube {
    ...
    protected void rotateDOWN() {
        if (currentSide == 0) {
            ...
            setValues(2, sideLength - 1, x, Direction.LEFT);
        } else if (currentSide == 2) {
            setValues(4, x, 0, direction);
        } else if (currentSide == 3) {
            setValues(5, x, 0, direction);
        } else if (currentSide == 4) {
            setValues(5, sideLength - 1, x, Direction.LEFT);
        } else if (currentSide == 5) {
    ...
    protected void rotateRight() {
        if (currentSide == 0 || currentSide == 3) {
            ...
            setValues(4, sideLength - 1, sideLength - 1 - y, Direction.LEFT);
        } else if (currentSide == 2) {
            setValues(1, y, sideLength - 1, Direction.UP);
        } else if (currentSide == 4) {
            setValues(1, sideLength - 1, sideLength - 1 - y, Direction.LEFT);
        } else if (currentSide == 5) {
            setValues(4, y, sideLength - 1, Direction.UP);
        }
    }
    ...
    protected void rotateLeft() {
        if (currentSide == 0) {
            setValues(3, 0, sideLength - 1 - y, Direction.RIGHT);
        } else if (currentSide == 1 || currentSide == 4) {
            setValues(currentSide - 1, sideLength - 1, y, direction);
        } else if (currentSide == 2) {
            setValues(3, y, 0, Direction.DOWN);
        } else if (currentSide == 3) {
            setValues(0, 0, sideLength - 1 - y, Direction.RIGHT);
        } else if (currentSide == 5) {
            setValues(0, y, 0, Direction.DOWN);
        }
    }
